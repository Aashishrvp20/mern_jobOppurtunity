...
const Register = () => {
  ...
  return (
    <div id="image1" className="min-h-screen flex items-center justify-center ">
      <div className="bg-white p-8 rounded shadow-lg w-full max-w-md transform transition-all duration-500 hover:scale-95">
